...
mixin _$CartStore on CartStoreBase, Store {
  ...
  bool get isMergeCart =>
      (_$isMergeCartComputed ??= Computed<bool>(() => super.isMergeCart, name: 'CartStoreBase.isMergeCart')).value;
  ...
  late final _$_isMergeCartAtom = Atom(name: 'CartStoreBase._isMergeCart', context: context);
  ...
  @override
  Future<void> setCartKey(String value, [dynamic guest = true]) {
